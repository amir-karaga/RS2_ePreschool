namespace ePreschool.Shared.Constants
{
    ...
    {
        public const string ResetPasswordSubject = "ePreschool Team | Resetovanje lozinke";
        public const string ConfirmationEmailSubject = "ePreschool Team | Dodjela korisničkog naloga";
        public const string ClientEmailSubject = "ePreschool Team | Dodjela uloge klijenta";
