import 'package:epreschool_admin/models/child.dart';
...
import 'package:epreschool_admin/screens/children/child_edit_screen.dart';
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ChildEditScreen(id: data.id),
            ),
          );
        },
        child: MouseRegion(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text(
                            "Date of enrollment: ${data.dateOfEnrollment}",
                            style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                              color: Colors.grey.shade500,
